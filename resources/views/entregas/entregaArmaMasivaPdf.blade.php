...
<head>
    <meta charset="UTF-8">
    <title>ACTA ENTREGA A UNIDAD.pdf</title>
</head>
<!--ESTILO...................................................................................-->
<style>
    html {
...
<body>
    <section>
        ...
        @if ($entrega->ud_entrega==24)
        <p style="text-align: center"><b><u>ACTA DE ENTREGA A UNIDAD</u></b></p>
        @else
        <p style="text-align: center"><b><u>ACTA DE ENTREGA A DEPENDENCIA</u></b></p>
        @endif
        <p style="text-align: justify">En la Ciudad de <b>{{$entrega->localidadEntrega->nom_localidad}}</b>, Departamento
            ...
            la presente a fin de dejar debidamente documentado que se hace entrega a el/la <b>{{$entrega->subUdRecibe->nom_subud}}</b>,
            de el/la <b>{{$entrega->udRecibe->nom_ud}}</b> de la cantidad de <b>{{ '('.$armas->count().')' }}</b> arma/s que se detalla/n a continuación.<br>
            Recibe por la misma el personal <b>NI: {{$entrega->personal->nlegajo_ps}} - {{$entrega->personal->nombre_ps}}</b>.
        </p>
        <br>
        ...
        <p style="text-align: justify">Motivo de la entrega: {{$entrega->obs}}</p>
