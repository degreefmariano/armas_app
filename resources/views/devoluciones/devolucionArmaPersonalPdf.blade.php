...
<head>
    <meta charset="UTF-8">
    <title>ACTA DEVOLUCION.pdf</title>
</head>
...
<body>
    <section>
        ...
        <p style="text-align: center"><b><u>ACTA DE DEVOLUCION PERSONALIZADA</u></b></p>
        ...
        <p style="text-align: justify">En la Ciudad de <b>{{$devolucion->localidadRecibe->nom_localidad}}</b>, Departamento
            ...
            la presente a fin de dejar debidamente documentado que comparece ante esta <b>NI: {{$devolucion->personal->nlegajo_ps}}
                - {{$devolucion->personal->nombre_ps}}</b>, quién al momento de la devolución presta servicios en <b>{{$devolucion->personal->subunidad->nom_subud}}</b>,
            de el/la <b>{{$devolucion->personal->unidad->nom_ud}}</b>.
        </p>
        <br>
