...
class ListadoEntregaArmaRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'legajo'       => [Rule::exists('personal','nlegajo_ps')],
            'ud_recibe'    => [Rule::exists('unidades','cod_ud')],
            'subud_recibe' => [Rule::exists('subunidades','cod_subud')],
            'tipo_entrega' => ['required', Rule::in([1,2])]
        ];
    ...
    public function messages()
    {
        return [
            ...
            'subud_recibe.exists'        => "La Sub Unidad seleccionada no existe.",
            'tipo_entrega.required'      => "Se debe ingresar el tipo de entrega",
            'tipo_entrega.in'            => "Tipo de entrega incorrecto"
        ];
    }
}
