...
use App\Rules\Arma\CheckArmaMismaUnidadRule;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class EntregaMasivaArmaRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'armas'      => ['array', new CheckArmaMismaUnidadRule($this['unidad'], $this['armas'])],
