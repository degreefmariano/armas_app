...
class ImportarArmaLargaRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'file'       => ['required', 'mimes:xlsx', 'file_name:template_armas_largas.xlsx'],
            'tipo'       => ['required'],
    ...
    public function messages()
    {
        return [
            ...
            'file_name'                  => 'El nombre del archivo debe ser template_armas_largas.xlsx',
